...
public class Register extends AppCompatActivity {
    private EditText userName, userPsw_1, userPsw_2, userPhone, userAddress;
    private Button register;
    private String name, psw,phone,address;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        userAddress = (EditText) findViewById(R.id.register_address);
